...
export const Placeholder = ({
  ...
  ...props}: IconProps) => {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill={fill} stroke={colour} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
...
export const Clear = ({
  ...
  ...props}: IconProps) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke={colour} xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const Drag = ({
  ...
  ...props}: IconProps) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke={colour} xmlns="http://www.w3.org/2000/svg" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" {...props}>
